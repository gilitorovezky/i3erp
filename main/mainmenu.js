...
const nametoIDLookup = {
    ...
    "Job SignIn":           {"name":"jobSigninTime",
                             "id":"jobSignInTimeID",
                             "header":"Job SignIn",
                             "modules":{"Employee Jobs":{"display":true,
                                                         "mandatory":false}}},

    "Job SignOut":          {"name":"jobSignoutTime",
                             "id":"jobSignOutTimeID",
                             "header":"Job SignOut",
                             "modules":{"Employee Jobs":{"display":true,
                                                         "mandatory":false}}},

    "Lunch SignIn":         {"name":"lunchSigninTime",
                             "id":"lunchSignInTimeID",
                             "header":"Lunch SignIn",
                             "modules":{"Employee Jobs":{"display":true,
                                                         "mandatory":false}}},
...
const headers = {
    ...
    "Vendors":{hash:'vndrs',callBack:upperRight,callType:"generalUpload",sn:"config",columns:'<thead id="mainHeader" class="mHeader"><tr><th></th><th>Vendor Name</th><th>Vendor Address</th><th>Notes</th><th style="width:100px">Files</th>',numOfCols:5,showInPrj:false,primaryKey:'vendor_id',tableName:'vendors',params:0},
    "Companies":{hash:'dcmpny',callBack:lowerRight,callType:"generalUpload",sn:"config",columns:'<thead id="mainHeader" class="mHeader"><tr><th></th><th>Company Name</th><th>Notes</th><th style="width:100px">Files</th>',numOfCols:4,showInPrj:false,primaryKey:'company_id',tableName:'companies',params:0},
    "Contractors":{hash:'dc',callBack:lowerLeft,callType:"generalUpload",sn:"config",columns:'<thead id="mainHeader" class="mHeader"><tr><th></th><th>Contractor Name</th><th>Notes</th><th style="width:100px">Files</th>',numOfCols:4,showInPrj:false,primaryKey:'contractor_id',tableName:'contractors',params:0},
    "Employees":{hash:'emplyees',callBack:manageEmployees,callType:"generalUpload",sn:"config",columns:'<thead id="mainHeader" class="mHeader"><tr><th></th><th>Full Name</th><th>Employment Type</th><th>Hourly Rate</th><th>Hourly Rate Date</th><th>Is Active</th><th>Password</th><th style="width:100px">Files</th>',numOfCols:8,showInPrj:false,primaryKey:'employee_id',tableName:'employees',params:"#result-table1"},
...
$(window).on("load", function() {
    ...
    windowLog.trace("inside window onload");
   windowLog.trace("inside onLoad load");
});
...
function displayMainMenue(screenName) {
    ...
    if ( username === 'eddie' ) { //only Eddie could access
        if ( screenName === "Home" ) {
            ...
            //$("#tHalf").html('<a><img tabindex="19" src="../misc/plus.png" width="10" id="mainNewTaskSchdlr" height="10"></a>');
            ...
            //$('#bHalf').html('<a><img tabindex="21" src="../misc/plus.png" id="newProject" width="10" height="10"></a>\n<input tabindex="22" type="text" class="prjShortCutInput" id="prjShortCut" name="projectNumber" size="20" maxlength="50">\n');
            $('#cText').invisible();
...
function AddingSort() { // making the table sortable
