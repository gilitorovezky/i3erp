<?php
    ...
    if ( mysqli_connect_errno() == 0 ) {
        $sql_st="SELECT module_id,module_name,screen_number,visible,permission,module_file_url,class_type,data,method,position FROM modules";
        ...
        if ( $modules->num_rows >0 ) {
            ...
            while ($row = mysqli_fetch_assoc($modules)) {   
                ...
                $ret_recs[$i] =  array("module_id"        => $row["module_id"],
                                        ...
                                        "module_file_url" => $row["module_file_url"],
                                        "data"            => $row["data"],
                                        "method"          => $row["method"],
